...
$(function(){
    ...
    $(document).mousemove(function(event){
        ...
        // console.log(x + ", " + y);
        $(".corner").mousemove(function(){
            if (x <= screenX*threshold1 && y <= screenY*threshold1){
                coords ="top left";
    
                $("#title1").html("Meeting ");
                $("#title2").html("Info:");
                $("#infoA").html("- General Details -");
                $("#infoB").html("Date, Time, Location");
            } else if (x >= screenX*threshold2 && y <= screenY*threshold1){
                coords ="top right";
    
                $("#title1").html("Lect");
                $("#title2").html("ure:");
                $("#infoA").html("- Lecture Title -");
                $("#infoB").html("Description");
                ...
                $("#title1").html("Beyond");
                $("#title2").html(" Bias:");
                $("#infoA").html("Building inclusive global creative collaboration");
                $("#infoB").html("[International Lecture Series]");
            }
        });
        ...
        $("#maria-carolina-cambre").mousemove(function(){
            if (corner == "Pink, Top Left") {
                ...
                $(".pink2.info1").html("<b>Contesting the colonial eye: “Burning the Mona Lisa”</b>");
                ...
                $(".pink.title").html("<img src='https://www.ocadu.ca/sites/default/files/2024-12/Picture2.png'>");
                $(".pink2.info1").html("<a class='pink2' href='https://www.concordia.ca/faculty/carolina-cambre.html' target='_blank'>Concordia University Profile</a>");
                $(".pink2.info2").html("");
                $(".pink2.info3").html("");
        ...
        $("#isabel-machado").mousemove(function(){
            if (corner == "Magenta, Top Left") {
                $(".magenta.title").html("Meeting Info:");
                ...
                $(".magenta2.info1").html("<b>Fostering Inclusive Communities in the Classroom through Project-Driven Courses.</b>");
                ...
                $(".magenta.title").html("<img src='https://www.ocadu.ca/sites/default/files/2024-12/Picture3.png'>");
                $(".magenta2.info1").html("<a class='magenta2' href='https://www.machadoisabel.com/' target='_blank'>machadoisabel.com</a>");
                $(".magenta2.info2").html("");
                $(".magenta2.info3").html("");
        ...
        $("#daniel-wildberger").mousemove(function(){
            if (corner == "Purple, Top Left") {
                $(".purple.title").html("Meeting Info:");
                ...
                $(".purple2.info1").html("<b>Branches: Weaving Stories in Design and Education</b>");
                ...
                $(".purple.title").html("<img src='https://www.ocadu.ca/sites/default/files/2024-12/Picture4.png'>");
                $(".purple2.info1").html("<a class='purple2' href='https://www.danielwildberger.com/' target='_blank'>danielwildberger.com</a>");
                $(".purple2.info2").html("");
                $(".purple2.info3").html("");
        ...
        $("#shima-rezaei-rashnoodi").mousemove(function(){
            if (corner == "Indigo, Top Left") {
                ...
                $(".indigo2.info1").html("<b>Being There: A Virtual Reality Museum of Migrant Women</b>");
                ...
                $(".indigo.title").html("<img src='https://www.ocadu.ca/sites/default/files/2024-12/Picture5.png'>");
                $(".indigo2.info1").html("<a class='indigo2' href='https://pure.buas.nl/en/persons/shima-rezaei-rashnoodi' target='_blank'>Breda University Profile</a>");
                $(".indigo2.info2").html("");
                $(".indigo2.info3").html("");
        ...
        if (corner.includes("Top Left") || coords == "top left") {
            $("#corner-i, #corner-d, #corner-s").css("opacity", "0.25");
            $("#corner-m").css("opacity", "0.75");
        } else if (corner.includes("Top Right") || coords == "top right") {
            $("#corner-m, #corner-d, #corner-s").css("opacity", "0.25");
            $("#corner-i").css("opacity", "0.75");
        } else if (corner.includes("Bottom Left") || coords == "bottom left") {
            $("#corner-m, #corner-i, #corner-s").css("opacity", "0.25");
            $("#corner-d").css("opacity", "0.75");
        } else if (corner.includes("Bottom Right") || coords == "bottom right") {
            $("#corner-m, #corner-i, #corner-d").css("opacity", "0.25");
            $("#corner-s").css("opacity", "0.75");
        } else if (corner == "" || coords == "") {
            $(".corner").css("opacity", "0.25");
        }
    });
});
...
/*
    ...
    $("#titles").hover(function(){        
        $(this).css({top: "37.5%", lineHeight: "15px"}, "swing");
        $("span.pink").css({fontSize: "45px", color: "rgb(182, 44, 116)"}, 200, "swing");
        $("span.magenta").css({fontSize: "45px", color: "rgb(186, 51, 163)"}, 300, "swing");
        $("i.purple").css({fontSize: "25px", color: "rgb(121, 38, 147)"}, 400, "swing");
        $("h2.indigo").css({fontSize: "25px", color: "rgb(102, 51, 185)"}, 500, "swing");
    }, function(){
        $(this).css({top: "36.5%", lineHeight: "20px"}, "swing");
        $("span.pink").css({fontSize: "55px", color: "rgb(208, 125, 168)"}, 500, "swing");
        $("span.magenta").css({fontSize: "55px", color: "rgb(228, 150, 215)"}, 400, "swing");
        $("i.purple").css({fontSize: "30px", color: "rgb(207, 152, 224)"}, 300, "swing");
        $("h2.indigo").css({fontSize: "30px", color: "rgb(168, 136, 219)"}, 200, "swing");
    });
    ...
    $("#titles").click(function(){
        ...
        $("#maria-carolina-cambre").css({top: "0", left: "0"}); 
        $("#isabel-machado").css({top: "0", left: "55%"}); 
        $("#daniel-wildberger").css({top: "67%", left: "0"}); 
        $("#shima-rezaei-rashnoodi").css({top: "67%", left: "55%"});
        ...
        $(".event").css({width: "45%"}, "slow", "swing");
        $(".event").css({height: "33%"}, "slow", "swing");
...
$(".pink2.info1, .pink2.info2, .location, .info1, .info2, img").hover(function(){
    ...
    $(this).css({color: "rgb(255, 171, 255)", opacity: "0.75"});

}, function(){
    $(".pink2").css({color: "rgb(182, 44, 116)", opacity: "1.0"}, 100);
    $(".magenta2").css({color: "rgb(186, 51, 163)", opacity: "1.0"}, 100);
    $(".purple2").css({color: "rgb(121, 38, 147)", opacity: "1.0"}, 100);
    $(".indigo2").css({color: "rgb(102, 51, 185)", opacity: "1.0"}, 100);
...
$("a").hover(function(){
    $(this).css({color: "rgb(255, 255, 255)", opacity: "0.75"});
}, function(){
    $(this).css("color", "");
...
$(".handle2").hover(function(){
    if (!scroll) {
        $(".handle2").css({opacity: "0.5", width: "25px", height: "25px"}, "swing");
    } else {
        $(".handle2").css({opacity: "1.0", width: "25px", height: "25px"}, "swing");
    }
}, function(){
    if (!scroll) {
        $(".handle2").css({opacity: "1.0", width: "20px", height: "20px"}, "swing");
    } else {
        $(".handle2").css({opacity: "0.5", width: "20px", height: "20px"}, "swing");
    }
});
...
$(".handle2").click(function(){
    if (!scroll) {
        ...
        $(".handle2").css({opacity: "0.5"}, "swing");
        scroll = true;
    } else {
        $(".event").css("overflow-y", "hidden");
        $(".handle2").css({opacity: "1.0"}, "swing");
        scroll = false;
    }   
});
